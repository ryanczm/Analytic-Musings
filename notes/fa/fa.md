...
* **The Player/Transfer Problem**
    ...
    * Idea - Styles - For a certain position, for a transfer from league X to Y, maybe styles have to do with it? In other words, the attributes of the player. Then, we can use FIFA/EAFC ratings to quantify (e.g weak and slow usually does not translate to PL). But this is a big stretch so...
