...
* **Core Strength Feature**
    ...
    * Incomings - I talk about possible approaches to the ex-ante transfer problem below. For ex-ante, we have market value, prices, player ratings (even FIFA ratings) at past clubs. But...
