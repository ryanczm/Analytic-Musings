...
* **Core Strength Feature**
    ...
    * Baseline - The baseline feature, in both season outcomes and baseline odds.
    * Differential - Baseline + differential, in both season outcomes and baseline odds. Does that improve predictive power?
    * Differential - The differential problem is equivalent to the transfer problem. In other words, quantifying how good the transfer window is, ex-ante, beyond using net spend as a proxy. This is an open problem.
