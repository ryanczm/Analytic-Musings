...
<p>My idea is that understanding complexity is about linking things together, but each field has different <i>things</i>, and each thing has it's own type of <i>link</i>.</p>
<br>
