...
First, identify the actions. Connect it to the deterministic/semi-deterministic framework. Then, identify the key actors, their contexts/perspectives, and understand why. Connect nodes across time to understand how the situation evolves.
