...
* Enriching a node via avenues: "who" (visualising the people involved), "what" (visualising their actions), "why" (visualising their rationale/objectives), "when" (when in time), "where" (where in place)
