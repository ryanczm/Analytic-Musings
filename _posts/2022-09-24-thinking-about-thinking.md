...
We can generalize the notion of _decomposition_ by _layers of abstraction_. The trick to understanding things in computer science might be to be able to work in linear fashion down the levels of abstraction, understanding how each one works in a top-to-bottom fashion.
