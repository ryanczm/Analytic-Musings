...
Exchanges are massive servers with specific messaging protocols communicating with market participants. For an instrument, no true concurrency, everything is a (very fast) queue.
